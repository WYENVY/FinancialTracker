...
export default function GiftsScreen() {
    ...
    useEffect(() => {
        ...
        const giftsExpensesRef = collection(db, 'usernames', user.uid, 'categories', 'Gifts', 'expenses');

        const unsubscribe = onSnapshot(giftsExpensesRef, (snapshot) => {
            ...
            <FlatList
                ...
                ListHeaderComponent={
                    <>
                        ...
                        <Text style={styles.title}>Gifts Category Details</Text>
                        <AddExpense categoryId="Gifts" />
                        <Text style={styles.sectionTitle}>Gifts Transactions</Text>
                    </>
                }
                renderItem={({ item }) => {
                ...
                ListEmptyComponent={<Text style={styles.emptyText}>No gifts expenses yet.</Text>}
