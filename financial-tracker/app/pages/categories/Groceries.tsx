...
export default function GroceriesScreen() {
    ...
    useEffect(() => {
        ...
        const groceriesExpensesRef = collection(db, 'usernames', user.uid, 'categories', 'Groceries', 'expenses');

        const unsubscribe = onSnapshot(groceriesExpensesRef, (snapshot) => {
            ...
            <FlatList
                ...
                ListHeaderComponent={
                    <>
                        ...
                        <Text style={styles.title}>Groceries Category Details</Text>
                        <AddExpense categoryId="Groceries" />
                        <Text style={styles.sectionTitle}>Groceries Transactions</Text>
                    </>
                }
                renderItem={({ item }) => {
                ...
                ListEmptyComponent={<Text style={styles.emptyText}>No groceries expenses yet.</Text>}
