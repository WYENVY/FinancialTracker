...
export default function TransportScreen() {
    ...
    useEffect(() => {
        ...
        const transportExpensesRef = collection(db, 'usernames', user.uid, 'categories', 'Transport', 'expenses');

        const unsubscribe = onSnapshot(transportExpensesRef, (snapshot) => {
            ...
            <FlatList
                ...
                ListHeaderComponent={
                    <>
                        ...
                        <Text style={styles.title}>Transport Category Details</Text>
                        <AddExpense categoryId="Transport" />
                        <Text style={styles.sectionTitle}>Transport Transactions</Text>
                    </>
                }
                renderItem={({ item }) => {
                ...
                ListEmptyComponent={<Text style={styles.emptyText}>No transport expenses yet.</Text>}
